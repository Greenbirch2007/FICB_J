...
if __name__=="__main__":
    ...
    for oneurl in url_list:
        ...
        try:
            ...
            pattern = re.compile('<th class="alC">6カ月</th>.*?<td .*?>(.*?)</td>', re.S)
            ...
            print(json_list)
            writeintoTSV_file("sbi_trust_since_6months_ago.tsv",json_list_tsv)

        except:
            pass

    writeinto_jsonfile("sbi_trust_since_6months_ago.json",json_list)
